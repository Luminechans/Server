            ...
            <View style={styles.categoryContainer}>
                <View style={styles.resultsContainer}>
                    ...
                    <View style={styles.manShoesContainer}>
                        ...
                        <AntDesign name="down" size={24} color="#9098B1" style={{ marginLeft: 4 }} />
                    </View>
                </View>
                <View style={styles.productsContainer}>
                    {
                        products.map(product => {
                            return (
                                <Pressable
                                    onPress={() => navigation.navigate('Detail', { id: product._id })} style={styles.product}>
            ...
            <View>
                <View style={styles.searchContainer}>
                    <View style={styles.searchTextContainer}>
                        ...
                        <TextInput style={styles.textInput} placeholder={'Nike Air Max'} />

                    </View>
                    <View style={styles.searchRightContainer}>
                        <Image style={styles.imageInputContainer} source={require('../../../../assets/images/iconSearch1.png')} />
